          ...
          <Card title="Notification Configuration" subtitle="Enable channels and recipients for registration alerts">
            <form onSubmit={handleSaveSystem} className="space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <BooleanField label="Email & SMS 15 minutes before start, and when an event starts or ends" name="emailOnEventReminder" checked={systemForm.notifications.emailOnEventReminder} onChange={(e) => handleSystemChange('notifications', e)} />
