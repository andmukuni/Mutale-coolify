...
export default function BlogPage() {
  ...
  const page = profile.websitePages?.blog || defaultWebsitePages.blog;
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-navy-950 via-navy-900 to-navy-800 text-white py-16 sm:py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <span className="inline-block text-xs font-semibold uppercase tracking-widest text-cyan-400 mb-3">{page.headerEyebrow || defaultWebsitePages.blog.headerEyebrow}</span>
            <h1 className="text-4xl sm:text-5xl font-bold mb-4">{page.headerTitle || defaultWebsitePages.blog.headerTitle}</h1>
            <p className="text-lg text-navy-300 leading-relaxed">
              {page.headerIntro || defaultWebsitePages.blog.headerIntro}
            </p>
          </div>
        </div>
      </section>
