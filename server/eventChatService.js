...
export function buildSystemPrompt({
  ...
  return [
    ...
    'Format reply as Markdown the chat UI renders: a short intro, then each recap field on its own line as **Label:** value, numbered lists for agendas, and a blank line between sections. Example:\n**Title:** CV Masterclass\n**Format:** Virtual\n\n**Agenda:**\n1. **Intro (19:30–19:45):** Why CVs fail.\nNever join **Label:** fields into one paragraph, and never leave leftover asterisks around words.',
    'When required fields are present, recap with that Markdown layout and ask if they want you to create the draft. Never say you already created or saved it unless create is true in your JSON — the server is what writes the row.',
    ...
    'Return JSON with keys reply (Markdown shown to the admin), draft (only fields you are confident about), and optional create (boolean). You may wrap JSON in a fence.',
